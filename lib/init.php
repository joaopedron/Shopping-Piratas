...
function _asv_setup() {
	 ...
	 * If you're building a theme based on _asv, use a find and replace
	 * to change '_asv' to the name of your theme in all the template files
	 */
	load_theme_textdomain( '_asv', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( '_asv_custom_background_args', array(
...
add_action( 'after_setup_theme', '_asv_setup' );
